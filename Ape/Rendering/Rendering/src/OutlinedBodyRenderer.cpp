...
auto OutlinedBodyRenderer::render(
    ...
    -> void
{
    performStandardRenderingAndFillStencilBuffer(bodies, camera, lightSystem, fog, shadowMapping);
    ...
    -> void
{
    ...
    standardRenderer.render(bodies, camera, lightSystem, fog, shadowMapping);
}
